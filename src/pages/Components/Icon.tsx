...
const DATA_URL = "https://raw.githubusercontent.com/alex-willow/framerkit-data/components/icon.json";
const CACHE_KEY = `remote:${DATA_URL}`;
const DATA_KEY = "icon" as const;
    ...
    <div id="icon-page" style={{ padding: 0, scrollMarginTop: "64px" }}>
      ...
      <div className="component-page-header">
        <nav className="component-breadcrumb">
          ...
          <span className="breadcrumb-current">Icon</span>
        </nav>
        <h2 className="component-page-title">Icon Components</h2>
        <p className="component-page-description">
          Icons communicate meaning quickly and reduce reading load. Pair them with labels for clarity in
          navigation, controls, and feature highlights.
        </p>
      </div>
