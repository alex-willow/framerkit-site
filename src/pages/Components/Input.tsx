...
const DATA_URL = "https://raw.githubusercontent.com/alex-willow/framerkit-data/components/input.json";
const CACHE_KEY = `remote:${DATA_URL}`;
const DATA_KEY = "input" as const;
    ...
    <div id="input-page" style={{ padding: 0, scrollMarginTop: "64px" }}>
      ...
      <div className="component-page-header">
        <nav className="component-breadcrumb">
          ...
          <span className="breadcrumb-current">Input</span>
        </nav>
        <h2 className="component-page-title">Input Components</h2>
        <p className="component-page-description">
          Inputs are for fast, low-friction data entry. Use clear labels, helpful placeholders, and visible
          validation states so users always know what to do next.
        </p>
      </div>
