...
const DATA_URL = "https://raw.githubusercontent.com/alex-willow/framerkit-data/components/testimonialcard.json";
const CACHE_KEY = `remote:${DATA_URL}`;
const DATA_KEY = "Testimonialcard" as const;
    ...
    <div id="testimonial-card-page" style={{ padding: 0, scrollMarginTop: "64px" }}>
      ...
      <div className="component-page-header">
        <nav className="component-breadcrumb">
          ...
          <span className="breadcrumb-current">Testimonial Card</span>
        </nav>
        <h2 className="component-page-title">Testimonial Card Components</h2>
        <p className="component-page-description">
          Testimonial cards turn customer feedback into social proof. Keep quotes short, specific, and paired
          with real names or roles to build confidence quickly.
        </p>
      </div>
