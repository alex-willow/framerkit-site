...
const DATA_URL = "https://raw.githubusercontent.com/alex-willow/framerkit-data/components/rating.json";
const CACHE_KEY = `remote:${DATA_URL}`;
const DATA_KEY = "rating" as const;

export default function RatingPage({ isAuthenticated, setIsSignInOpen }: RatingPageProps) {
    ...
    <div id="rating-page" style={{ padding: 0, scrollMarginTop: "64px" }}>
      ...
      <div className="component-page-header">
        <nav className="component-breadcrumb">
          ...
          <span className="breadcrumb-current">Rating</span>
        </nav>
        <h2 className="component-page-title">Rating Components</h2>
        <p className="component-page-description">
          Ratings provide instant trust signals from real user feedback. Place them near products, services,
          and testimonials to reinforce quality at a glance.
        </p>
      </div>
