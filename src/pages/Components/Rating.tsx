...
export default function RatingPage({ 
  ...
  useEffect(() => {
    const load = async () => {
      // Фильтруем только компоненты из секции "components/rating"
      const ratingItems = components.filter(item => item.section === "components/rating");
      const filteredItems = ratingItems.filter(item =>
