...
const DATA_URL = "https://raw.githubusercontent.com/alex-willow/framerkit-data/components/avatargroup.json";
const CACHE_KEY = `remote:${DATA_URL}`;
const DATA_KEY = "avatargroup" as const;
    ...
    <div id="avatar-group-page" style={{ padding: 0, scrollMarginTop: "64px" }}>
      ...
      <div className="component-page-header">
        <nav className="component-breadcrumb">
          ...
          <span className="breadcrumb-current">Avatar Group</span>
        </nav>
        <h2 className="component-page-title">Avatar Group Components</h2>
        <p className="component-page-description">
          Avatar groups show teams, participants, or social proof in a compact space. Perfect when you need
          to communicate "who is involved" without taking over the layout.
        </p>
      </div>
