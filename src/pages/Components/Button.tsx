...
const DATA_URL = "https://raw.githubusercontent.com/alex-willow/framerkit-data/components/button.json";
const CACHE_KEY = `remote:${DATA_URL}`;
const DATA_KEY = "button" as const;
    ...
    <div id="button-page" style={{ padding: 0, scrollMarginTop: "64px" }}>
      ...
      <div className="component-page-header">
        <nav className="component-breadcrumb">
          ...
          <span className="breadcrumb-current">Button</span>
        </nav>
        <h2 className="component-page-title">Button Components</h2>
        <p className="component-page-description">
          Buttons drive the main action on every screen. Keep one strong primary action, and use secondary
          buttons for less important steps so users always know where to click.
        </p>
      </div>
