...
const DATA_URL = "https://raw.githubusercontent.com/alex-willow/framerkit-data/components/avatar.json";
const CACHE_KEY = `remote:${DATA_URL}`;
const DATA_KEY = "avatar" as const;
    ...
    <div id="avatar-page" style={{ padding: 0, scrollMarginTop: "64px" }}>
      ...
      <div className="component-page-header">
        <nav className="component-breadcrumb">
          ...
          <span className="breadcrumb-current">Avatar</span>
        </nav>
        <h2 className="component-page-title">Avatar Components</h2>
        <p className="component-page-description">
          Avatars add a human touch to profiles, comments, and team blocks. Use them when you want users,
          authors, or teammates to be recognized instantly.
        </p>
      </div>
