...
const DATA_URL = "https://raw.githubusercontent.com/alex-willow/framerkit-data/main/feature.json";
const CACHE_KEY = `remote:${DATA_URL}`;
const DATA_KEY = "feature" as const;
    ...
    <div id="feature-page" style={{ padding: 0, scrollMarginTop: "64px" }}>
      ...
      <div className="component-page-header">
        <nav className="component-breadcrumb">
          ...
          <span className="breadcrumb-current">Feature</span>
        </nav>
        <h2 className="component-page-title">Feature Components</h2>
        <p className="component-page-description">
          Use feature sections to explain value in scannable chunks. Lead with outcomes, then support each point with short details users can understand in seconds.
        </p>
      </div>
