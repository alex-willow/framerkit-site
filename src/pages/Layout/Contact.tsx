...
const DATA_URL = "https://raw.githubusercontent.com/alex-willow/framerkit-data/main/contact.json";
const CACHE_KEY = `remote:${DATA_URL}`;
const DATA_KEY = "contact" as const;
  ...
  return (
    <div id="contact-page" style={{ padding: 0, scrollMarginTop: "64px" }}>
      ...
      <div className="component-page-header">
        ...
        <h2 className="component-page-title">Contact Components</h2>
        <p className="component-page-description">
          Use contact sections near the end of the page to capture intent. Keep the form short, add one clear next step, and remove anything that slows submission.
        </p>
      </div>
