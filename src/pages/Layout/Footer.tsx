...
const DATA_URL = "https://raw.githubusercontent.com/alex-willow/framerkit-data/main/footer.json";
const CACHE_KEY = `remote:${DATA_URL}`;
const DATA_KEY = "footer" as const;
    ...
    <div id="footer-page" style={{ padding: 0, scrollMarginTop: "64px" }}>
      ...
      <div className="component-page-header">
        <nav className="component-breadcrumb">
          ...
          <span className="breadcrumb-current">Footer</span>
        </nav>
        <h2 className="component-page-title">Footer Components</h2>
        <p className="component-page-description">
          Use footer sections as the final navigation and trust layer. Keep links grouped by intent and include essential legal, contact, and product paths.
        </p>
      </div>
