...
const DATA_URL = "https://raw.githubusercontent.com/alex-willow/framerkit-data/main/cta.json";
const CACHE_KEY = `remote:${DATA_URL}`;
const DATA_KEY = "cta" as const;
    ...
    <div id="cta-page" style={{ padding: 0, scrollMarginTop: "64px" }}>
      ...
      <div className="component-page-header">
        <nav className="component-breadcrumb">
          ...
          <span className="breadcrumb-current">CTA</span>
        </nav>
        <h2 className="component-page-title">CTA Components</h2>
        <p className="component-page-description">
          Use CTA sections to transition users from reading to action. Keep one primary action per block and place it after a clear benefit statement.
        </p>
      </div>
