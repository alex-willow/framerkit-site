...
export default function BlogPage() {
  return (
    <div style={{ width: '100%', paddingRight: '220px', boxSizing: 'border-box' }}>
      <div className="blog-page" style={{ padding: '36px 20px', maxWidth: '700px', margin: '0 auto', fontFamily: 'Inter, sans-serif' }}>
      <header className="blog-header" style={{ marginBottom: '28px' }}>
        ...
        <p style={{ fontSize: '18px', color: '#4b5563', lineHeight: 1.6, margin: 0 }}>
          Product updates, tutorials, and design notes from FramerKit.
        </p>
      </header>
      ...
      <div className="blog-placeholder" style={{ 
        ...
        <p style={{ fontSize: '16px', color: '#4b5563', marginBottom: '20px', lineHeight: 1.6 }}>
          We are working on detailed articles and practical Framer guides.
        </p>
        <Link to="/learn" className="btn btn-primary" style={{ 
